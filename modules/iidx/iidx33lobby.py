...
@router.post("/{gameinfo}/IIDX33lobby/entry")
async def iidx33lobby_entry(request: Request):
...
@router.post("/{gameinfo}/IIDX33lobby/update")
async def iidx33lobby_update(request: Request):
    request_info = await core_process_request(request)

    response = E.response(E.IIDX33lobby())

    response_body, response_headers = await core_prepare_response(request, response)
    return Response(content=response_body, headers=response_headers)


@router.post("/{gameinfo}/IIDX33lobby/delete")
async def iidx33lobby_delete(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33lobby/bplbattle_entry")
async def iidx33lobby_bplbattle_entry(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33lobby/bplbattle_update")
async def iidx33lobby_bplbattle_update(request: Request):
    request_info = await core_process_request(request)
...
@router.post("/{gameinfo}/IIDX33lobby/bplbattle_delete")
async def iidx33lobby_bplbattle_delete(request: Request):
    request_info = await core_process_request(request)
